...
We're talking more than 600'000 blocks with a size of over 400 GB, so this is not an easy task.
...
* Use the Bitcoin Core client `bitcoin-cli` with user "bitcoin" to get information about the current blockchain
